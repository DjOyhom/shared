...
def call(String dir = 'human') {
  ...
  sh 'cd ' + "${dir}" + ' && echo {\'PUTAapiVersion\': \'apps.openshift.io/v1\',\'kind\': \'DeploymentConfig\',\'metadata\': {\'name\': \'hugitoweb\',\'namespace\': \'hugo\'},\'spec\': {\'triggers\': [{\'imageChangeParams\': {\'automatic\': \'true\',\'containerNames\':[\'hugitoweb\'],\'from\': {\'kind\': \'ImageStreamTag\',\'name\':\'hugito:$(cat image_version.txt)\',\'namespace\': \'hugo\'}},\'type\': \'ImageChange\'},{\'type\': \'ConfigChange\'}]} >> deploy.json'
